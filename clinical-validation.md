...
<p style="max-width:820px; margin:14px auto 0; font-size:0.95rem; color:#666;">
  Note: This material is provided for evidence and transparency. It does not provide diagnosis or medical advice.
</p>
...
- **Validation Report (PDF):** study context, protocols, analysis approach, results, and supporting evidence for review readiness.
...
If you have questions or would like a walkthrough, feel free to contact me.
